...
class GameColors {
  ...
  static const Color primary = Color(0xFFF7D08A);
  static const Color secondary = Color(0xFFE3F09B);
  static const Color accent = Color(0xFF87B6A7);
  static const Color success = Color(0xFF5B5941);
